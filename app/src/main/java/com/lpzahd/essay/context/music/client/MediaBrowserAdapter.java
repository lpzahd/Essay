package com.lpzahd.essay.context.music.client;
...
public class MediaBrowserAdapter {
    ...
    public void onStart() {
        ...
        L.e("onStart: Creating MediaBrowser, and connecting");
    }
    ...
    public void onStop() {
        ...
        resetState();
        L.e("onStop: Releasing MediaController, Disconnecting from MediaBrowser");
    }
    ...
    public MediaControllerCompat.TransportControls getTransportControls() {
        if (mMediaController == null) {
            L.e("getTransportControls: MediaController is null!");
    ...
    public class MediaBrowserConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
        ...
        public void onConnected() {
            try {
                ...
                L.e(String.format("onConnected: Problem: %s", e.toString()));
    ...
    public class MediaControllerCallback extends MediaControllerCompat.Callback {
        ...
        public void onMetadataChanged(final MediaMetadataCompat metadata) {
            ...
            if (isMediaIdSame(metadata, mState.getMediaMetadata())) {
                L.e("onMetadataChanged: Filtering out needless onMetadataChanged() update");
                return;
            } else {
        ...
        public void onSessionDestroyed() {
            ...
            L.e("onSessionDestroyed: MusicService is dead!!!");
        }
