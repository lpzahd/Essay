...
public class SimpleVideo extends StandardGSYVideoPlayer {
     ...
     * @return
     */
    public boolean setUp(List<Video> url, boolean cacheWithPlay, String title) {
        mUrlList = url;
        return setUp(url.get(mSourcePosition).url, cacheWithPlay, title);
    }
     ...
     * @return
     */
    public boolean setUp(List<Video> url, boolean cacheWithPlay, File cachePath, String title) {
        mUrlList = url;
        return setUp(url.get(mSourcePosition).url, cacheWithPlay, cachePath, title);
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        SimpleVideo simpleVideo = (SimpleVideo) super.startWindowFullscreen(context, actionBar, statusBar);
        simpleVideo.mSourcePosition = mSourcePosition;
        simpleVideo.mType = mType;
        simpleVideo.mTransformSize = mTransformSize;
        simpleVideo.mUrlList = mUrlList;
        simpleVideo.mTypeText = mTypeText;
        //simpleVideo.resolveTransform();
        simpleVideo.resolveTypeUI();
        //simpleVideo.resolveRotateUI();
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            SimpleVideo simpleVideo = (SimpleVideo) gsyVideoPlayer;
            mSourcePosition = simpleVideo.mSourcePosition;
            mType = simpleVideo.mType;
            mTransformSize = simpleVideo.mTransformSize;
            mTypeText = simpleVideo.mTypeText;
